          ...
          <div style={{ maxWidth: 900, margin: "0 auto", padding: "14px 12px 140px" }}>
            ...
            {!tournamentOpen && (
              <div style={{ background: "rgba(185,28,28,.1)", border: "1px solid rgba(185,28,28,.3)", borderRadius: 10, padding: "14px 18px", marginBottom: 16, textAlign: "center" }}>
                ...
                <div style={{ fontSize: 12, color: "rgba(240,237,230,.4)", marginTop: 4 }}>Дедлайн: 11 июня 2026, старт первого матча ЧМ</div>
              </div>
            )}
            {tournamentOpen && (
              <div style={{ fontSize: 11, color: "rgba(240,237,230,.35)", textAlign: "center", marginBottom: 12 }}>
                🗓 Дедлайн прогнозов: <strong style={{ color: "rgba(240,237,230,.5)" }}>11 июня 2026</strong>, старт первого матча ЧМ
              </div>
            )}
              ...
              <div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10, marginBottom: 20 }}>
                  ...
                  <div className="mode-card clubs" style={{ padding: "16px 14px", borderLeft: "4px solid #16A34A" }}>
                    ...
                    <div style={{ fontSize: 11, color: "rgba(240,237,230,.5)", marginBottom: 8, lineHeight: 1.6 }}>
                  ...
                  <div className="mode-card clubs" style={{ padding: "16px 14px" }}>
                    ...
                    <div style={{ fontSize: 11, color: "rgba(240,237,230,.4)", marginBottom: 10 }}>
                      👥 Участников: <strong style={{ color: "#FDE68A" }}>{leagueCount !== null ? leagueCount : "…"}</strong>
                    </div>
                    {(hasLeagueAccess) ? (
                      <div>
