              ...
              <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 500 }}>
                <thead>
                  <tr style={{ background: "rgba(22,163,74,.08)" }}>
                    <th style={{ textAlign: "left", padding: "8px 10px", fontSize: 10, color: "rgba(240,237,230,.45)", textTransform: "uppercase" }}>Игрок</th>
                ...
                <tbody>
                  {orderedSlots(card.slots).map((slot, i) => {
                    const pts = slot.option_id !== undefined ? playerScores[slot.option_id] : undefined;
                    const ptsDisplay = pts !== undefined && pts !== null ? String(pts) : "—";
                    const ptsColor = pts === undefined || pts === null ? "#F59E0B" : pts > 0 ? "#86EFAC" : "rgba(240,237,230,.4)";
                    return (
                    <tr key={`${card.user_id || idx}-${slot.slot_key || i}`} style={{ borderTop: "1px solid rgba(255,255,255,.05)" }}>
                      ...
                      <td style={{ padding: "7px 10px", textAlign: "center" }}>
                        <span style={{ display: "inline-block", minWidth: 34, padding: "2px 6px", borderRadius: 5, background: "rgba(255,255,255,.04)", border: "1px solid rgba(255,255,255,.08)", color: ptsColor, fontFamily: "Oswald,sans-serif", fontWeight: 800 }}>
                          {ptsDisplay}
                        </span>
                      </td>
                    </tr>
