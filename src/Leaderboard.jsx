...
// Таблица "Общей лиги": две вкладки — Очки (сумма за всё время) и Победы
// (матчи/победы/% побед по личным дуэлям 1×1, заполняется с Бриллиантовой лигой).
export default function Leaderboard({ user }) {
  const [tab, setTab] = useState("points"); // "points" | "wins"
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 md:p-8">
      ...
      {tab === "points" ? <PointsTab user={user} /> : <WinsTab user={user} />}
    </div>
  );
}
