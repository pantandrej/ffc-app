...
function withCriticalTournamentPlayers(players = []) {
  ...
  for (const fp of CRITICAL_TOURNAMENT_PLAYER_FALLBACKS) {
    const aliases = [fp.name, displayPlayerName(fp.name), "Эрлинг Хааланд", "Эрлинг Холанд", "Haaland", "Хааланд", "Холанд"];
...
const DRAFT_NAME_RU = {
  ...
  "Erling Haaland":"Эрлинг Хааланд","Erling Håland":"Эрлинг Хааланд","Эрлинг Холанд":"Эрлинг Хааланд","Эрлинг Хааланд":"Эрлинг Хааланд","Lionel Messi":"Лионель Месси","Vinicius Jr":"Винисиус Жуниор",
