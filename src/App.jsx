          ...
          {allCurrent.map((m, i) => (
            <div key={i} style={{ background: "rgba(255,255,255,.03)", border: "1px solid rgba(245,158,11,.18)", borderRadius: 14, padding: 12 }}>
              ...
              <div style={{ display: "flex", gap: 16, alignItems: "center", justifyContent: "center", flexWrap: "wrap" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Oswald,sans-serif", fontSize: 34, fontWeight: 900, color: "#F59E0B", minWidth: 48 }}>VS</div>
...
function PublicForecastTable({ showToast, onLeaderboardReady }) {
  ...
  function publicPlayoffTeamsForUser(u, matchId) {
    ...
    function predictedSideForBracket(bracket, teams) {
      ...
      if (!pen) return null;
      if (["1", "home", "h", "хозяева"].includes(pen)) return "home";
      if (["2", "away", "a", "гости"].includes(pen)) return "away";
