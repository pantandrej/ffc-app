...
export default function App() {
  ...
  async function saveClub() {
    if (!session?.access_token) { showToast("Войди в аккаунт"); return; }
    ...
    // Явно строим fetch с правильным Authorization: Bearer user_access_token
    ...
    if (!res.ok) {
      ...
      showToast(`Не удалось сохранить клуб (${res.status}): ${text.slice(0, 120)}`);
      return;
    }

    // Перезагрузить профиль из БД — убеждаемся что данные реально сохранились
