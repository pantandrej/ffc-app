              ...
              <div style={{ maxWidth: 540 }}>
                {[
                  ...
                  { title: "B. Битва клубов — бесплатно", icon: "⚽", items: [
                    ...
                    "Очки игроков: вратарь: сухой матч +6, сейв пенальти +8; защитник: сухой матч +5, гол +8; полузащитник: гол +6, пас +5; нападающий: гол +5 (+3 за 2-й, +6 за хет-трик), пас +4.",
                    "Тренер: победа +5, ничья +2, 3+ гола в команде +2.",
                    "Штрафы: жёлтая −1, красная −4, незабитый пенальти нападающим −3.",
                  ]},
