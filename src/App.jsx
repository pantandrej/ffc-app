...
1,forward2,Нападающий 2,12,forward,5,Patrik Schick,Чехия,Гол,false`;
  ...
  return (
    <div>
      ...
      <div className="tabs">
        {[["users", "👥 Участники"], ["forecast_table", "📋 Таблица"], ["results", "Результаты"], ["players", "Игроки"], ["club_battle", "⚔ Битва клубов"], ["fairplay", "Fair Play"], ["ffc", "⚽ FFC"], ["quiz", "🧠 Квизы"], ["settings", "Настройки"], ["payments", "Заявки"], ["voronka", "Воронка"]].map(([k, l]) => (
