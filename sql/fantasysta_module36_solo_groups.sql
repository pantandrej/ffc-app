...
-- Топ-12 личного зачёта (пока после тура 3 — группы предварительные, тур 3
-- ещё не завершён) разбиты змейкой на 2 группы по 6: группа A — места
...
-- ---------------------------------------------------------------------------
-- Состав групп — змейка 1,4,5,8,9,12 / 2,3,6,7,10,11 по текущему личному зачёту
-- ---------------------------------------------------------------------------
INSERT INTO public.solo_group_members (group_label, seed, profile_id) VALUES
  ('A', 1, 'b7063b65-f51e-4e66-9cef-66d4a52a65ad'), -- Andrej Panteleew (место 1)
  ('A', 2, '25fd6c0c-f0a9-474b-aaea-53e653683fac'), -- Antonio Golubew (место 4)
  ('A', 3, 'a0000000-0000-0000-0000-00000000c6a1'), -- Гаптузо (место 5)
  ...
  ('B', 1, 'df97ee31-9a87-4462-933d-53e03c1c5bec'), -- alexaraxela (место 2)
  ('B', 2, 'ff2ef5ef-01c4-48e0-839b-e71964fdc4b7'), -- Nikita Krikun (место 3)
  ('B', 3, 'd73d5238-d27d-4f86-9e78-c51d1ec97a49'), -- dr.aseifeddine (место 6)
